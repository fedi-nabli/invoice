  ...
  <div v-if="currentInvoice" class="invoice-view container">
    ...
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button @click="deleteIv(currentInvoice.docId)" class="red">Delete</button>
        <button
...
export default {
  ...
  methods: {
    ...
    ...mapActions(['deleteInvoice', 'updateStatusToPaid', 'updateStatusToPending']),
